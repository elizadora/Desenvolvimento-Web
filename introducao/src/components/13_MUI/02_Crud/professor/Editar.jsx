...
const Editar = () => {
    ...
    // const professores = [
    //     {id:0, nome: "Vitor Corleone", curso: "SI", titulacao: "MEST", ai: {cg:true, mc:false, al:false ,es:false}},
    ...
    //     {id:3, nome: "Kay Adams", curso: "SI", titulacao: "DOUT", ai: {cg:false, mc:false, al:false ,es:false}},
    //     {id:4, nome: "Peter Clemenza", curso: "CC", titulacao: "MEST", ai: {cg:false, mc:false, al:true ,es:false}}
    // ]
    ...
    // como esta [] vazio o useEffect funciona como construtor
    useEffect(
        () =>{
